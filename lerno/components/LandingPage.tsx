...
import { WavyBackground } from "@/lerno/ui/wavy-background";
import { ContainerScroll } from "@/lerno/ui/container-scroll-animation";
import { HoverEffect } from "@/lerno/ui/card-hover-effect";
import { AceternityButton } from "@/lerno/ui/aceternity-button";
import AceternityNavbar from "@/lerno/components/AceternityNavbar";
import PricingComponent from "@/lerno/components/PricingSection";
import Footer from "@/lerno/components/Footer";
    ...
    <div className="bg-black relative min-h-screen">
      ...
      <WavyBackground className="max-w-4xl mx-auto pb-40">
        ...
        <div className="flex justify-center mt-8">
          <AceternityButton onClick={() => router.push("/dashboard")}>
